...
>
	...
	<div class="container-custom relative z-10 text-center">
		<div class="max-w-4xl mx-auto">
			<!-- Greeting -->
			<p class="hero-greeting text-lg md:text-xl text-[var(--text-secondary)] mb-4 opacity-0">
				👋 Hello, I'm
			</p>

			<!-- Name -->
			<h1
				class="hero-name text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold mb-6 opacity-0"
			>
			...
			<!-- Title -->
			<h2
				class="hero-title text-2xl sm:text-3xl md:text-4xl font-display font-medium text-[var(--text-primary)] mb-6 opacity-0"
			>
			...
			<!-- Tagline -->
			<p
				class="hero-tagline text-lg md:text-xl text-[var(--text-secondary)] max-w-2xl mx-auto mb-10 opacity-0"
			>
				Building elegant, performant, and accessible web experiences from Chicago, Illinois.
			...
			<div class="hero-cta flex flex-wrap justify-center gap-4 mb-12 opacity-0">
				...
				<a
					href="#contact"
					class="inline-flex items-center gap-2 px-8 py-4 rounded-full border-2 border-[var(--border-color)] text-[var(--text-primary)] font-semibold hover:border-primary-500 hover:text-primary-500 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
				>
					Get In Touch
				</a>
			</div>
			...
			<div class="flex justify-center gap-6">
				<a
					...
					class="hero-social-link opacity-0 p-3 rounded-full bg-[var(--bg-secondary)] hover:bg-[var(--bg-tertiary)] text-[var(--text-secondary)] hover:text-primary-500 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500"
	...
	<div class="absolute bottom-8 left-1/2 -translate-x-1/2">
		<a
			href="#about"
			class="scroll-indicator flex flex-col items-center gap-2 text-[var(--text-tertiary)] hover:text-primary-500 transition-colors"
