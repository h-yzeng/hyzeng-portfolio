...
<section
	...
	id="about"
	class="section-padding bg-[var(--bg-secondary)]"
	...
	<div class="container-custom">
		...
		<div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
			...
			<div class="about-content space-y-6">
				<p class="text-xl md:text-2xl font-display text-[var(--text-primary)] leading-relaxed">
				...
				<p class="text-lg text-[var(--text-secondary)] leading-relaxed">
					[What drives me is the ability to turn complex problems into elegant solutions. I'm
					always excited to take on new challenges and collaborate with like-minded individuals who
			...
			<div class="about-graphic relative">
				...
				<div
					class="relative aspect-square max-w-md mx-auto bg-gradient-to-br from-primary-500/10 to-accent-500/10 rounded-3xl p-8"
				>
					<!-- Decorative Border -->
					<div
						class="absolute inset-0 rounded-3xl gradient-border"
					></div>
					...
					<div class="relative h-full flex items-center justify-center">
						...
						{#each techIcons as icon, i}
							<div
								class="tech-icon absolute w-12 h-12 rounded-xl bg-[var(--bg-primary)] shadow-lg flex items-center justify-center"
								style="
